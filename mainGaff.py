...
from pysimm.models.monomers.gaff.pe import monomer as pe_monomer
from pysimm.models.monomers.gaff.ps import monomer as ps_monomer
from pysimm.models.monomers.gaff.ba import monomer as ba_monomer
from pysimm.models.monomers.gaff.peg5 import monomer as peg_monomer
from pysimm.models.monomers.gaff.amide import monomer as amide_monomer
from pysimm.models.monomers.gaff.disE import monomer as dise_monomer
from pysimm.models.monomers.gaff.disG import monomer as disg_monomer
from pysimm.models.monomers.gaff.disI import monomer as disi_monomer
...
def run(test=False):
    ...
    m = polymer.molecules.add(system.Molecule())
    dreiding_salt_ = polymer.particle_types.add(f.particle_types.get(salt)[0].copy())
    polymer.particles.add(system.Particle(type=dreiding_salt_, x=polymer.dim.dx / 2, y=polymer.dim.dy / 2, z=polymer.dim.dz / 2,charge=-charge, molecule=m))
    lmps.quick_min(polymer, min_style='sd')
